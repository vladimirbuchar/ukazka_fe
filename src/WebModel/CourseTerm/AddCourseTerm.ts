...
export class AddCourseTerm {
    ...
    constructor (courseId: string, price: Price, activeFrom: Date, activeTo: Date, registrationFrom: Date, registrationTo: Date, minimumStudents: number, maximumStudents: number, classRoomId: string|null, monday: boolean, tuesday: boolean, wednesday: boolean, thursday: boolean, friday: boolean, saturday: boolean, sunday: boolean, timeFromId: string, timeToId: string, userAccessToken: string, name: string, description: string, lector: [],
      studentGroup: [], organizationStudyHourId: string) {
